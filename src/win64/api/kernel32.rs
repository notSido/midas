...
pub fn virtual_alloc(emu: &mut Unicorn<()>, workspace: &mut u64) -> Result<u64> {
...
pub fn virtual_protect(emu: &mut Unicorn<()>) -> Result<()> {
...
/// GetProcAddress stub
pub fn get_proc_address(emu: &mut Unicorn<()>) -> Result<()> {
...
/// LoadLibraryA stub
pub fn load_library_a(emu: &mut Unicorn<()>) -> Result<()> {
...
/// GetTickCount stub
pub fn get_tick_count(emu: &mut Unicorn<()>) -> Result<()> {
...
pub fn query_performance_counter(emu: &mut Unicorn<()>) -> Result<()> {
